...
namespace Nikolaev_RA_Project4_Var1_sideA_lib.LogParser
{
    ...
    public class WriteLog : ConsoleUiBase
    {
        ...
        private string? ParseLog(bool isFileOutput, List<Log> logs)
        {
            ...
            string path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "../../../../Nikolaev_RA_Project4_Var1_sideA_lib/Configs/customConfig.json");
                ...
                || config.FieldsOrder.Length == 0)
            {
                ...
                string defaultConfigPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "../../../../Nikolaev_RA_Project4_Var1_sideA_lib/Configs/defaultConfig.json");
